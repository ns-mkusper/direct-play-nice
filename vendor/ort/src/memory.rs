...
impl MemoryInfo {
	...
	pub fn device_type(&self) -> DeviceType {
		// Some older runtime builds expose a smaller OrtApi table than the one this crate was
		// generated against. In that case, the MemoryInfoGetDeviceType slot may be absent/null.
		// Fallback to CPU to avoid null-function-pointer crashes when running inference.
		if crate::requested_api_version() < crate::MINOR_VERSION {
